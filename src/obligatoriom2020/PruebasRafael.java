...
import static obligatoriom2020.ObligatorioM2020.prueba1;

public class PruebasRafael {

    public static void main(String[] args) {
        // TODO code application logic here
        Sistema s = new Sistema(3);
        Prueba p = new Prueba();
        pruebaEstructura(s,p);
       pruebatopes(s,p);
        //prueba1(s, p);
    }
    ...
    public static void pruebaEstructura(Sistema s, Prueba p) {
        ...
        //-------------------------------------------------------------------------------------------------------------
        // instancia del archivo que contiene el mensaje. para probar la funcionalidad referente a lineas y palabras 
        //  NodoCarpetas mensaje = s.unidad.getLc().obtenerElemento("Archivos").getLm().obtenerElemento("mensaje1");
        // juego de prueba para las lineas, palabras y diccionario.
        //------------------------------------------------------------------------------------------------------------
        // p.ver(s.InsertarLinea().resultado, Retorno.Resultado.OK, "Se agrego una linea al arvhivo mensaje");
        // listamos la carpeta nuevamente para ver si estan los arvhivos correctos.    p.ver(s.ListarEstructura("C","Archivos").resultado,Retorno.Resultado.OK,"Se listan los documentos de la carpeta Archivos");
       ...
       // p.ver(s.BuscarCamino(s.Ciudades, "MVD", "NYC").resultado, Retorno.Resultado.OK, s.BuscarCamino(s.Ciudades, "MVD", "NYC").valorString);
    ...
    public static void pruebatopes(Sistema s, Prueba p) {
        ...
        p.ver(s.InsertarPalabraYDesplazar("C", "Archivos", "mensaje1", 1, 2, "PalabraX").resultado, Retorno.Resultado.OK, "Insertada y desplazada");
...
//    public static void pruebaDiccionario(Sistema1 s, Prueba p) {
...
//    }
//
//    public static void pruebaOperacionesPalabras(Sistema1 s, Prueba p) {
//        p.ver(s.crearSistemaMensajes().resultado, Retorno.Resultado.OK, "Se creo Sistema con una unidad C");
...
//    }
//
//    public static void pruebaSinErrores(Sistema1 s, Prueba p) {
//        p.ver(s.crearSistemaMensajes().resultado, Retorno.Resultado.OK, "Se creo Sistema con una unidad C");
//        p.ver(s.AgregarCarpeta("C", "Personal").resultado, Retorno.Resultado.OK, "Se creo carpeta -> Personal en Unidad C");
//        p.ver(s.AgregarCarpeta("C", "Universidad").resultado, Retorno.Resultado.OK, "Se creo carpeta -> Universidad en Unidad C");
//        p.ver(s.AgregarCarpeta("C", "Trabajo").resultado, Retorno.Resultado.OK, "Se creo carpeta -> Trabajo en Unidad C");
...
//
//        /**
//         * *** BORRAR TODO DE DOC PROGRAMACION E IMPRIMIR PARA VERIFICAR QUE NO
//         * ESTEN LOS DATOS ****
//         */
...
//    }
//
//    public static void pruebaErroresCrearCarpeta(Sistema1 s, Prueba p) {
//        p.ver(s.crearSistemaMensajes().resultado, Retorno.Resultado.OK, "Se creo Sistema con una unidad C");
//        p.ver(s.AgregarCarpeta("C", "Personal").resultado, Retorno.Resultado.OK, "Se creo carpeta -> Personal en Unidad C");
//        p.ver(s.AgregarCarpeta("C", "Universidad").resultado, Retorno.Resultado.OK, "Se creo carpeta -> Universidad en Unidad C");
//        p.ver(s.AgregarMensaje("C", "Universidad", "Programacion").resultado, Retorno.Resultado.OK, "Se agrego Mensaje/Documento Programacion a la carpeta Universidad de unidad C");
